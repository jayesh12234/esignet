...
public class EsignetUtil extends AdminTestUtil {
	...
	public static void seedPreconfiguredIdsFromConfig() {
		String oidcClientId = EsignetConfigManager.getproperty("oidcClientId");
	...
	public static String resolveClientId(String clientIdKey) {
		...
		if ("$ID:CreateOIDCClient_all_Valid_Smoke_sid_clientId$".equals(clientIdKey)) {
		...
		throw new SkipException("No client ID in cache or config for " + clientIdKey);
	}
